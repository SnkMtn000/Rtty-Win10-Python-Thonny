# My WIndows 10 Feld Hell with Tk
...
# def mark():
#     pysine.sine(frequency = markFreq, duration = 0.0214)
#         
# def space():
#     pysine.sine(frequency = spaceFreq, duration = 0.0214)
...
def transmit():
    ...
    if (len(textboxValue) > 0):
        ...
        textboxValue = ""
        hellChar = list(bitStream)
        for thing in hellChar:
            if thing == '1':
                    pysine.sine(frequency=dit, duration=bit_time)
            else:
